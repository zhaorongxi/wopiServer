 ...
 * Created by zhaorx on 2019/1/16.
 */
public class FileInfo implements Serializable {
	...
	public String toString() {
		return "FileInfo [baseFileName=" + baseFileName + ", ownerId=" + ownerId + ", size=" + size + ", sha256="
				+ sha256 + ", version=" + version + ", errorMsg=" + errorMsg + ", allowExternalMarketplace="
				+ allowExternalMarketplace + ", userCanWrite=" + userCanWrite + ", supportsUpdate=" + supportsUpdate
